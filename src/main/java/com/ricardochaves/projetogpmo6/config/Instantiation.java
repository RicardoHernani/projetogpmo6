...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Procedimento pro1 = new Procedimento(null, 11111111, sdf.parse("20/02/2020"), 1, 1, "31102360", ref1, new UsuarioDTO(ricardo));
		Procedimento pro2 = new Procedimento(null, 11111111, sdf.parse("26/02/2020"), 2, 1, "31102077", ref2, new UsuarioDTO(ricardo));
		Procedimento pro3 = new Procedimento(null, 11111111, sdf.parse("26/05/2011"), 1, 1, "30908027", ref3, new UsuarioDTO(ricardo));
		Procedimento pro4 = new Procedimento(null, 22222222, sdf.parse("10/10/2009"), 1, 2, "30202094",ref4, new UsuarioDTO(debora));
		Procedimento pro5 = new Procedimento(null, 33333333, sdf.parse("15/08/2013"), 1, 1, "30715016",ref5, new UsuarioDTO(debora));
		Procedimento pro6 = new Procedimento(null, 44444444, sdf.parse("07/02/2000"), 1, 2, "31003567",ref9, new UsuarioDTO(ana));
		Procedimento pro7 = new Procedimento(null, 44444444, sdf.parse("07/02/2000"), 2, 2, "30729017", ref10, new UsuarioDTO(ana));
		Procedimento pro8 = new Procedimento(null, 44444444, sdf.parse("24/12/2010"), 1, 1, "30908027", ref3, new UsuarioDTO(ana));
		Procedimento pro9 = new Procedimento(null, 55555555, sdf.parse("13/05/1998"), 1, 2, "31201113", ref6, new UsuarioDTO(ana));
		Procedimento pro10 = new Procedimento(null, 66666666, sdf.parse("27/06/2019"), 1, 2, "30908027", ref3, new UsuarioDTO(ana));
